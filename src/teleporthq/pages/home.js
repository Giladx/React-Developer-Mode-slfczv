...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>React Developer Mode</title>
        <meta property="og:title" content="React Developer Mode" />
      </Helmet>
          ...
          <div className="home-max-width max-content-container">
            ...
            <div className="home-gallery">
              <div className="home-container1">
                <img
                  alt="image"
                  src="/playground_assets/rectangle 95.png"
              ...
              <div className="home-container2">
                ...
                <img
                  alt="image"
                  src="/playground_assets/rectangle 95 [2].png"
              ...
              <div className="home-container3">
                <img
                  alt="image"
                  src="/playground_assets/rectangle 95 [3].png"
                  className="home-image3"
                />
                <div className="home-container4">
                  <img
                    alt="image"
                    src="/playground_assets/rectangle 95 [4].png"
                    className="home-image4"
                  />
                  <img
                    alt="image"
                    src="/playground_assets/rectangle 95 [5].png"
        ...
        <div className="home-services section-container">
          <div className="home-max-width1 max-content-container">
            ...
            <div className="home-cards-container">
              ...
              <ServicesCard
                text="Copy-writting"
                image_src="/playground_assets/file-document.png"
              ></ServicesCard>
              <ServicesCard
                text="Product Design"
                image_src="/playground_assets/dice-5.png"
              ></ServicesCard>
            </div>
          </div>
        </div>
        <div className="section-container">
          <div className="home-max-width2 max-content-container">
            ...
            <div className="home-tab-selector-cards-container">
              <PortofolioCard
                image_src="/playground_assets/unsplash_qj15unotnh0.png"
                rootClassName="portofolio-card-root-class-name"
              ></PortofolioCard>
              <PortofolioCard
                image_src="/playground_assets/unsplash_wwqrpsnbpq4.png"
        ...
        <div className="home-about section-container">
          <div className="home-max-width3 max-content-container">
            ...
            <div className="home-image-container">
              <img
                alt="image"
                src="/playground_assets/rectangle 109.png"
          ...
          <div className="home-max-width5 max-content-container">
            ...
            <div className="home-blog-cards-container">
              ...
              <BlogCard
                text1="Aug 14, 2022"
                button="advertising"
                image_src="/playground_assets/rectangle 99 [1].png"
                rootClassName="blog-card-root-class-name1"
              ></BlogCard>
              <BlogCard
                text1="Jul 12, 2022"
                button="Branding"
                image_src="/playground_assets/unsplash_h7qmwoxf6z8.png"
              ></BlogCard>
            </div>
          </div>
        </div>
      ...
      <div className="section-container">
        ...
        <footer className="home-max-width8 max-content-container">
          <img
            alt="image"
            src="/playground_assets/logo1.png"
